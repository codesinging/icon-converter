<template>
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" :fill="fill" class="bi bi-file-earmark-lock2-fill" viewBox="0 0 16 16">
...
<script>
export default {
    name: "PinIconFileEarmarkLock2Fill",
    props: {
        size: {
            type: [Number, String],
            default: '1rem'
